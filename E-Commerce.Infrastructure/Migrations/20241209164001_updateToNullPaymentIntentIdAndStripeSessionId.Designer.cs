...
namespace E_Commerce.Infrastructure.Migrations
{
    ...
    [Migration("20241209164001_updateToNullPaymentIntentIdAndStripeSessionId")]
    partial class updateToNullPaymentIntentIdAndStripeSessionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.CartDetails", b =>
                {
                    b.HasOne("E_Commerce.Core.Entities.CartHeader", "CartHeader")
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.CartHeader", b =>
                {
                    ...
                    b.HasOne("E_Commerce.Core.Entities.ApplicationUser", "User")
                        .WithMany("CartHeaders")
            ...
            modelBuilder.Entity("E_Commerce.Core.Entities.OrderDetails", b =>
                {
                    b.HasOne("E_Commerce.Core.Entities.OrderHeader", "OrderHeader")
